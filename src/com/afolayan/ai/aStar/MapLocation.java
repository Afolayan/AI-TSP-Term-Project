...
public class MapLocation {
    ...
    static ArrayList<MapLocation> loadMapLocationsArray() {
        return new ArrayList<>(Arrays.asList(loadMapLocations()));
    }

    static double[][] locationDistanceMatrix(ArrayList<MapLocation> mapLocations) {
